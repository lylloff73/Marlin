...
#define CUSTOM_MACHINE_NAME "Ender-4 ME"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "086e5edc-27d7-432b-a064-e71fd75db861"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  // Ender-4
    ...
    #define DEFAULT_Ki_LIST {   2.65,   2.65 }
    #define DEFAULT_Kd_LIST {  77.51,  77.51 }
  #else
...
#define PIDTEMPBED
  ...
  // Ender-4
#define  DEFAULT_bedKp 201.57
#define  DEFAULT_bedKi 38.69
#define  DEFAULT_bedKd 262.58
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT    { 80, 80, 400, 140.70 }
...
#define CLASSIC_JERK
  ...
  //#define LIMITED_JERK_EDITING        // Limit edit via M205 or LCD to DEFAULT_aJERK * 2
    ...
    #define MAX_JERK_EDIT_VALUES { 20, 20, 1.2, 10 } // ...or, set your own edit limits
  #endif
#endif
